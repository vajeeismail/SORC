                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                ...
                                <a class="dropdown-item active" href="showSubject.php" style="color: darkgray; background-color:black;">Edit Subject</a>
                            </div>
                        </li>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($results)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="deleteSubject.php?delete=<?php echo $row['SubCode']; ?>" class="btn btn-outline-danger" onclick="return confirm('Are you sure you want to delete this subject record?')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
