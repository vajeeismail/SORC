                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                ...
                                <a class="dropdown-item active" href="showDepartment.php" style="color: darkgray; background-color:black;">Edit Department</a>
                            </div>
                        </li>
        ...
        <div class="jumbotron" style="background: smoke; padding-bottom:10px">
            ...
            <div class="jumbotron" style="background: white; padding-bottom:10px">
                ...
                <div align="center" class="row-12">
                    <footer class="blockquote-footer"><cite title="Source Title">The form shows records of department</cite></footer></blockquote>
                </div>
                <br>
                <table class="table table-hover">
                    ...
                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                        <tr>
                            ...
                            <td>
                                <button href="updateDepartment.php?"<?php echo $row['DepID']; ?> class="btn btn-warning" 
                            ...
                            <td>
                            <a href="deleteDepartment.php?delete=<?php echo $row['DepID']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this department record?')">Delete</a>
                            </td>
                        </tr>
                       <?php } ?>
                </table>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="depID" name="depID" readonly>
                        </div>
                        <div class="form-group">
                ...
                <script>
                function populateUpdateForm(depID, dep) {
