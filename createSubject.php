...
<div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                <a class="dropdown-item active" href="createSubject.php" style="color: darkgray; background-color:black">Create New Subject</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                ...
                                <a class="dropdown-item" href="showAdmin.php" style="color: darkgray;">Edit Staff</a>
                            </div>
                        </li>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <form action="createSubject.php" method="POST" class="needs-validation" novalidate>
