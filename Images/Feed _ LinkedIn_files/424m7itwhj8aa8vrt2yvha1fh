...
e.default=o}))
define("participate-text-editor/components/text-editor",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/component","@ember/template-factory","@glimmer/tracking","@ember/service","@glimmer/component","@ember/object","@ember/utils","global-utils/utils/keyboard-utils","editor-shared/utils/constants","editor-shared/utils/text-editor-utils","editor-shared/utils/editor-setup","@ember/debug","global-utils/utils/is-browser","editor-shared/utils/quill/utils","editor-shared/utils/quill/delta-model-transformers","global-utils/utils/url","ember-lifeline","editor-shared/utils/tracking/texteditor-tracking","ember-cli-pemberly-tracking/utils/tracking","editor-shared/utils/tracking/mentions-tracking","editor-shared/utils/tracking/hashtag-tracking"],(function(e,t,i,r,a,o,n,s,l,d,p,c,h,u,m,f,y,g,b,T,x,v,E,_,w,S){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var k,O,P,C,A,R,H,M,D,j,I,F
const L=(0,n.createTemplateFactory)({id:"GfX+HlPL",block:'[[[11,0],[24,0,"editor-container"],[17,1],[12],[1,"\\n  "],[11,0],[4,[38,0],[[30,0,["initEditor"]]],null],[12],[1,"\\n    "],[11,0],[24,0,"editor-content"],[16,"data-jump-link-target",[30,2]],[16,"ondragover",[30,0,["onEditorDragover"]]],[4,[38,1],[[30,3]],null],[4,[38,2],[[30,0,["onDisabledAttrChange"]],[30,4]],null],[4,[38,3],["aria-activedescendant"],[["value","selector"],[[30,5],".ql-editor"]]],[4,[38,4],[[30,0,["onEditorEvents"]]],null],[12],[1,"\\n    "],[13],[1,"\\n\\n"],[41,[30,0,["isTypeaheadAbleToExpand"]],[[[44,[[52,[30,0,["isReusableTypeaheadCollectionGraphqlEnabled"]],[52,[30,0,["mentionShouldOpen"]],[52,[30,0,["groupUrn"]],[28,[37,7],null,[["transform","queryContext","type","q"],[[30,0,["transformTypeaheadResponse"]],[28,[37,8],null,[["groupUrn"],[[30,0,["groupUrn"]]]]],"GROUP_MEMBERS","type"]]],[28,[37,7],null,[["transform","typeaheadUseCase"],[[30,0,["transformTypeaheadResponse"]],"MENTIONS"]]]],[28,[37,7],null,[["type"],["HASHTAG"]]]],[52,[30,0,["mentionShouldOpen"]],[52,[30,0,["groupUrn"]],[28,[37,9],null,[["transform","queryContext","type","q"],[[30,0,["transformTypeaheadResponse"]],[28,[37,8],null,[["groupUrn"],[[30,0,["groupUrn"]]]]],"GROUP_MEMBERS","type"]]],[28,[37,9],null,[["transform","typeaheadUseCase"],[[30,0,["transformTypeaheadResponse"]],"MENTIONS"]]]],[28,[37,9],null,[["type"],["HASHTAG"]]]]]],[[[1,"        "],[8,[39,10],null,[["@fetchFn","@typeaheadQuery","@onTypeaheadResultsRendered","@typeaheadSelect","@triggered-content"],[[30,6],[30,0,["typeaheadQuery"]],[30,0,["onTypeaheadResultsRendered"]],[30,0,["typeaheadSelect"]],[30,7]]],null],[1,"\\n"]],[6]]]],[]],null],[1,"  "],[13],[1,"\\n"],[13]],["&attrs","@jumpLinkTarget","@controlName","@disabled","@ariaActiveId","queryFunction","@triggered-content"],false,["did-insert","ember-cli-pemberly-tracking@track-interaction","did-update","global-modifiers@set-attr","participate-text-editor@editor-events","if","let","search-ta-kit@graphql-fetch-results","hash","search-ta-kit@dash-fetch-results","participate-text-editor@typeahead-fetch"]]',moduleName:"participate-text-editor/components/text-editor.hbs",isStrictMode:!1}),U=/[\n][\n ]+$/g
let q=(k=(0,l.inject)("tracking"),O=(0,l.inject)("lix"),P=(0,l.inject)("i18n"),C=class extends d.default{constructor(){super(...arguments);(0,t.default)(this,"tracking",A,this);(0,t.default)(this,"lix",R,this);(0,t.default)(this,"i18n",H,this);(0,t.default)(this,"hashtagShouldOpen",M,this);(0,t.default)(this,"mentionShouldOpen",D,this);(0,t.default)(this,"workflowId",j,this);(0,t.default)(this,"typeaheadQuery",I,this);(0,t.default)(this,"commentary",F,this)}get isTypeaheadAbleToExpand(){return this.hashtagShouldOpen||this.mentionShouldOpen}get groupUrn(){return this.args.groupIdForMentionsTypeahead?`urn:li:fsd_group:${this.args.groupIdForMentionsTypeahead}`:void 0}get texteditorTracker(){return new E.default(this.tracking,this.workflowId)}get dropDownIsActive(){return this.isTypeaheadAbleToExpand&&(0,c.isPresent)(this.args.ariaActiveId)}get isReusableTypeaheadCollectionGraphqlEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.search-reusable-typeahead-collection-graphql-migration")}_filterTypeaheadResults(e,t){const i=t?e.filter((e=>(0,p.get)(e,"trackingUrn")===(0,p.get)(t,"trackingUrn")))[0]:null,r=e.filter((e=>!["ESCAPE_HATCH","AUTO_COMPLETE"].includes((0,p.get)(e,"type"))))
...
if(a||o){const a=(0,T.deltaFromTextMentionsObject)(e)
i&&r.setText(r.getText().replace(U,""))
const o=r.getContents(0,r.getLength()-1)
r.setContents(o.concat(a))
const{startCursor:n=r.getLength(),endCursor:s=0}=t
r.setSelection(n,s)}}_handleReportedTextChanges(e){var t,i
if(!e)return
const{mentions:r,text:a}=(0,T.deltaToTextMentionsObject)(e),o=e.ops.filter((e=>!(0,p.get)(e,"attributes.mention")&&!(0,p.get)(e,"attributes.hashtag"))).reduce(((e,t)=>e.concat((0,x.getUrlsFromText)(t.insert,!0))),[])
if(o.length){var n,s
null===(n=(s=this.args).onFoundUrl)||void 0===n||n.call(s,o[0])}null===(t=(i=this.args).textChangeHandler)||void 0===t||t.call(i,r,a.replace(U,""))}_handleArrowKey(e,t){var i,r
e.preventDefault()
...
break}case u.TYPEAHEAD_TYPES_MAP.HASHTAG:{const t={searchHeader:(0,S.getSearchHeaderForHashtagTrackingEvent)(this.typeaheadQuery),results:(0,m.getFormattedHashtagResults)(e),hashtagSourceType:"TYPEAHEAD"}
...
e&&(e.style.top=`${this.typeaheadTopPosition}px`)}initEditor(e){if(e){var t,i,r,a,o,n,s,l
const d=(0,f.setupQuillEditor)(e,(()=>!this.isDestroying&&this.dropDownIsActive),this.args.placeholder,this.i18n.lookupTranslation("components/participate-text-editor@text-editor","i18n_editor_aria-label")(),(e=>(0,v.debounceTask)(this,"_handleReportedTextChanges",e,(0,v.getTimeoutOrTestFallback)(300))),this.args.firstTextChangeHandler,this._openTypeahead.bind(this),this._dismissTypeaheadType.bind(this),this._generateNewWorkflowId.bind(this),this._fireCustomTexteditorTrackingEvent.bind(this),this._fireControlInteractionEvent.bind(this),this.args.shouldFocusOnRender,this.args.trackableRootObject)
this.editor=d
this.editorWrapperElement=e
this.editorElement=this.editorWrapperElement.querySelector(u.QUILL_EDITOR_SELECTOR);("share_add_commentary"===this.args.controlName?this.args.initialContent.hasText:!!this.args.initialContent)&&this._appendTextAndMentions(this.args.initialContent,this.args.cursorRange)
...
null===(s=(l=this.args).setPlaceholderTextHandler)||void 0===s||s.call(l,this._updatePlaceholderText.bind(this))
...
null===(r=(a=this.args).onSubmitCommentOnEnter)||void 0===r||r.call(a,e.replace(U,""),t)}}onDisabledAttrChange(){this.editor.enable(!this.args.disabled)}onEditorDragover(e){e.preventDefault()
...
define.alias("hue-web-icons/helpers/get-asset-url","participate-text-editor/helpers/get-asset-url")
