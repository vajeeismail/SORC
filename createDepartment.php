...
if(isset($_POST['btnCreate']))
{
    ...
    $sql = "INSERT INTO department (DepID, Department)
...
<div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                <a class="dropdown-item active" href="createDepartment.php"  style="color: darkgray; background-color:black">Create New Department</a>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <form action="createDepartment.php" method="POST" class="needs-validation" novalidate>
                <div class="jumbotron" style="background: white; padding-bottom:10px">
                    
                    <div align="center" class="row-12">
                        <footer class="blockquote-footer"><cite title="Source Title">Create new department in this form</cite></footer></blockquote>
                    </div>
                    <br>
                    
                    <div class="form-group">
                        <label for="departmentID">Department ID</label>
                        <input type="text" class="form-control" placeholder="Enter Department ID" name="departmentID" required>
                        <div class="invalid-feedback">Please fill out the department ID this field.</div>
                    </div>    

                    <div class="form-group">
                        <label for="department">Department:</label>
                        <input type="text" class="form-control" placeholder="Enter Department" name="department" required>
                        <div class="invalid-feedback">Please fill out the staff department name this field.</div>
                    </div>
