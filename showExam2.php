...
<div class="container-fluid">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                ...
                                <a class="dropdown-item active" href="showExam2.php" style="color: darkgray; background-color:black;">Edit Exam</a>
                            </div>
                        </li>
    ...
    <div class="container">
        ...
        <?php $results = mysqli_query($conn, "SELECT * FROM exams"); ?>
        ...
        <div class="jumbotron" style="background: smoke; padding-bottom:10px">
            ...
            <div class="jumbotron" style="background: white; padding-bottom:10px">
                ...
                <div align="center" class="row-12">
                    <footer class="blockquote-footer"><cite title="Source Title">The form shows records of exams</cite></footer></blockquote>
                </div>
                <br>
                ...
                <table class="table table-hover">
                    ...
                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="deleteExam2.php?delete=<?php echo urlencode($row['ExYear'] . ',' . $row['Semester'] . ',' . $row['Department']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this exam record?')">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
                ...
                <div class="modal fade" id="updateFormModal" tabindex="-1" role="dialog" aria-labelledby="updateFormModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="updateExam2.php" method="POST">
                    ...
                    <script>
                        function openUpdateForm(code, exYear, semester, department) {
                            document.querySelector('select[name="exYear"]').value = exYear;
                            document.querySelector('select[name="exSemi"]').value = semester;
