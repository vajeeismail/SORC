...
if(isset($_POST['btnCreate']))
{
    ...
    $adminame = $_POST['adminName'];
    $adminmobile = $_POST['adminMobile'];
    $adminmail = $_POST['adminMail'];

    $sql = "INSERT INTO admintable (AdminID, AdminName, AdminMobile, AdminMail)
    VALUES ('$adminid', '$adminame', '$adminmobile', '$adminmail')";
...
<div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                <a class="dropdown-item active" href="createAdmin.php" style="color: darkgray; background-color:black;">Create New Admin</a>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <form action="createAdmin.php" method="POST" class="needs-validation" novalidate>
                <div class="jumbotron" style="background: white; padding-bottom:10px">

                    <div align="center" class="row-12">
                        <footer class="blockquote-footer"><cite title="Source Title">Create new admin in this form</cite></footer></blockquote>
                    </div>
                    <br>
                    
                    <div class="form-group">
                        <label for="adminID">Admin ID:</label>
                        <input type="text" class="form-control" placeholder="SAM/ADMIN/00" name="adminID" required>
                        <div class="invalid-feedback">Please fill out the admin's id this field.</div>
                    </div>
                    <div class="form-group">
                        <label for="adminName">Admin Name:</label>
                        <input type="text" class="form-control" placeholder="Enter name" name="adminName" required>
                        <div class="invalid-feedback">Please fill out the admin's name this field.</div>
                    </div>
                    <div class="form-group">
                        <label for="adminMobile">Admin Mobile:</label>
                        <input type="text" class="form-control" placeholder="Enter mobile number" name="adminMobile" required>
                        <div class="invalid-feedback">Please fill out the admin's mbile no this field.</div>
                    </div>
                    <div class="form-group">
                        <label for="adminMail">Admin Mail:</label>
                        <input type="email" class="form-control" placeholder="Enter Mail" name="adminMail" required>
                        <div class="invalid-feedback">Please fill outadmin's mail this field.</div>
                    </div>
                    <br>
                    <div class="form-group">
