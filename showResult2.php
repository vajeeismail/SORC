                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                ...
                                <a class="dropdown-item active" href="showResult2.php" style="color: darkgray;">Edit Results</a>
                            </div>
                        </li>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php while ($row = mysqli_fetch_array($results)) { ?>
                            <tr>
                                ...
                                <td>
                                <a href="deleteResult2.php?delete=<?php echo urlencode($row['StudentID'] . ',' . $row['StuBatch'] .
