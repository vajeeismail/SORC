                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                ...
                                <a class="dropdown-item active" href="showStudent.php" style="color: darkgray; background-color:black;">Edit Student</a>
                            </div>
                        </li>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php while ($row = mysqli_fetch_array($results)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="deleteStudent.php?delete=<?php echo $row['StudentID']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this student record?')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
