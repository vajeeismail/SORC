...
<div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                <a class="dropdown-item active" href="createStudent.php" style="color: darkgray; background-color:black">Create New Student</a>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <form action="createStudent.php" method="POST" class="needs-validation" novalidate>
                <div class="jumbotron" style="background: white; padding-bottom:10px">
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">Please select the staff department this field.</div>
                    </div>
