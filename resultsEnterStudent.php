...
if (isset($_POST['btnSubmit'])) {
    ...
    header("Location: resultsFormStudent.php?department=$selectedDepartment&exYear=$selectedExYear&semester=$selectedSemester&batch=$batch&stuID=$stuID");
    exit();
}
?>
            ...
            <div class="container p-3 my-3 border">    
                <div class="jumbotron" style="background-color:whitesmoke;">
                    <div align="center" class="form-group">
                        <p style="font-size: 25px;">SLIATE EXAMINATION RESULTS</p>
                    </div>
                    <br><br>
