...
if (isset($_POST['btnCreate'])) {
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        $insertQuery = "INSERT INTO exams (ExYear, Semester, Department)
...
<div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                <a class="dropdown-item active" href="createExam.php" style="color: darkgray;">Create New Exam</a>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <form action="createExam.php" method="POST" class="needs-validation" novalidate>
