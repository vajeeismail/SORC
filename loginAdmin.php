...
if(isset($_POST['btnlogin']))
{
    ...
    $sql = "SELECT LoginID, Username, Password, UserID, AdminID FROM adminlogin
    JOIN admintable ON adminlogin.UserID = admintable.adminID WHERE Username = '$username' AND Password = '$password'";
...
<div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="loginStaff.php"> Staff </a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <form action="loginAdmin.php" method="POST">
            <div class="row">
                ...
                <div class="col-sm-offset-2 col-sm-12"> 
                    <div class="form-group" align="center"> 
                        <button type="submit" name="btnlogin" value="Login" class="btn btn-outline-success btn-block" style="width: 600px;">Login</button>
                    </div>  
                </div>
    ...
    <div class="container">
        <form action="createAdminLogin.php" method="POST" class="needs-validation" novalidate>             
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="jumbotron" style="padding-top:20px; padding-buttom:20px; margin-bottom: 10px;">
                                <h3>Admin</h3>      
                                <footer class="blockquote-footer"><cite title="Source Title">Create New Admin's Account</cite></footer></blockquote>
                                <br>
                                <div class="jumbotron" style="background: white; padding-top:20px; padding-buttom:20px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="invalid-feedback">Please fill out the admin id id this field.</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="adminUsername">Username:</label>
                                        <input type="text" class="form-control" placeholder="Enter Username" name="adminUsername" required>
                                        <div class="invalid-feedback">Please fill out a username for create in this field.</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="adminPass">Password:</label>
                                        <input type="password" class="form-control" placeholder="Enter Password" name="adminPass" required>
