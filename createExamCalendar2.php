...
if (isset($_POST['btnCreate'])) {
    ...
    if (move_uploaded_file($_FILES['pdfFile']['tmp_name'], $targetFilePath)) {
        ...
        $sql = "INSERT INTO calendar (Year, Semester, File) VALUES ('$year', '$exSemi', '$fileName')";
        if ($conn->query($sql) === TRUE) {
            echo "Exam calendar created successfully";
        } else {
...
<div class="container-fluid">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1>CREATE EXAM CALENDAR</h1>      
            <footer class="blockquote-footer"><cite title="Source Title">Sliate - Sammanthurai (ATI)</cite></footer></blockquote>
            <br>
            <form action="createExamCalendar2.php" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                <div class="jumbotron" style="background: white; padding-bottom:10px">
                    ...
                    <div class="form-group">
                        <label for="year">Examination Year(Academic):</label>
                        <input type="text" class="form-control" placeholder="Enter Examination Year" name="year" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">Please choose a PDF file to upload.</div>
                    </div>
