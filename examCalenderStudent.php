...
<div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="examCalenderStudent.php">Exam Calendar</a>
                        </li>
    ...
    <div class="container">
        ...
        <div align="center" class="form-group">
            <p style="font-size: 25px;">EXAMINATION CALENDARS</p>
        </div>
        <br><br>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td>2021</td>
                    <td>2021</td>
                    <td><a href="path/to/download/file1.pdf" download>Download</a></td>
                  </tr>
                </tbody>
            </table>
        </div>
