...
<div class="container-fluid">
    ...
    <div align="center" style="background-color: rgb(45, 45, 49);">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:rgb(45, 45, 49);">
                                <a class="dropdown-item active" href="createResult.php" style="color: darkgray; background-color:black">Create New Results</a>
...
<div class="container">
    <div class="jumbotron">
        <form id="createResultForm" action="createResult.php" method="POST" class="needs-validation" novalidate>
