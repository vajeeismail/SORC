...
if(isset($_POST['btnLogin']))
{
    ...
    $sql = "SELECT Username, Password FROM loginadministator WHERE Username = '$username' AND Password = '$password'";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
    $count = mysqli_num_rows($result);
    if($count==1)
    {
        header("Location:mainAdminHome.php");
    }
    else
    {
        echo '<script>
...
<div class="container-fluid">
    ...
    <div class="container">
        <form action="loginMainAdmin.php" method="POST">
            <div class="row">
                <div class="col-sm-8">
