...
if(isset($_POST['btnChange']))
{
    ...
    $sql = "UPDATE adminlogin SET Username='$newname', Password='$newpass' WHERE Username='$oldname' AND Password='$oldpass'";
...
<div class="container-fluid">
    ...
    <div class="container">
        <div class="form-group">
            <div>
                <p style="font-size: 35px;"> <i class='fa fa-users'></i> Adminis Management (SLIATE - Samanthurai) <p>
